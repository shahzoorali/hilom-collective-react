/**
 * The admin icon set — one stroke style, one size grid, replacing the emoji
 * that rendered differently on every OS. Paths are 24×24, 2px stroke
 * (Feather/Lucide geometry), drawn in currentColor so they follow the text.
 */
const PATHS: Record<string, string> = {
  ...
  leaf: 'M11 20A7 7 0 0 1 4 13c0-6 5-10 16-10 0 11-4 16-10 16zM2 22c3-3 6-6 10-9',
  ...
  ticket: 'M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3a2 2 0 0 0 0 4v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a2 2 0 0 0 0-4zM13 5v2m0 4v2m0 4v2',
  yoga: 'M12 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM4 21l4-4 4 1 4-1 4 4M8 17l1-7h6l1 7M5 11l4-1m10 1-4-1',
  ...
  scroll: 'M8 21h12a2 2 0 0 0 2-2v-2H10v2a2 2 0 1 1-4 0V5a2 2 0 0 0-2-2 2 2 0 0 0-2 2v3h4M19 17V5a2 2 0 0 0-2-2H4M10 8h6m-6 4h6',
  ...
  cap: 'M22 10 12 5 2 10l10 5zM6 12v5c3 3 9 3 12 0v-5',
