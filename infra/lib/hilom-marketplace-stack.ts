...
export class HilomMarketplaceStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: HilomMarketplaceStackProps) {
    ...
    attach(facilitatorPortal, 'FacilitatorPortalInt', [
      ...
      ['/facilitator/bookings/{bookingId}/notes', [PUT]],
      ['/facilitator/messages', [GET]],
      ['/facilitator/bookings/{bookingId}/messages', [GET, POST]],
      ['/facilitator/clients', [GET]],
      ['/facilitator/clients/{clientEmail}', [GET, PUT]],
    ...
    attach(bookings, 'BookingsInt', [
      ...
      ['/bookings/{bookingId}/messages', [GET, POST]],
      ['/bookings/{bookingId}/review', [GET, PUT]],
    ...
    attach(eventRegistrations, 'EventRegistrationsInt', [
      ...
      // Previews a promo code's discount before checkout (0062).
      ['/events/{eventId}/promo-check', [POST]],
